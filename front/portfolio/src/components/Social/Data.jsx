...
function Data() {
    return (
        <div className='home__data' >
            <h1 className="flex home__title">Sebastian Gomez
                <svg
                    width="65"
                    height="65"
                    viewBox="0 0 48 48"
            ...
            <a href="https://drive.google.com/file/d/1xsxKDW2RfFMTazRfRas4DRdTyf9Cohiw/view" className='button button--flex' target="_blank" >
                Certificados
